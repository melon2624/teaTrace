...
<html>
	...
	<body>
		...
		<c:forEach var="list" items="${fertlist}">
			...
			<div class="items">
				<div class="item">
					<div class="item-tag"> 肥料名称</div>
					<div class="item-info"> ${list.FERT_NAME} </div>
				</div>
				<div class="item">
					<div class="item-tag"> 肥料成分</div>
					<div class="item-info"> ${list.FERT_CONTENT}</div>
				</div>
				<div class="item">
					<div class="item-tag"> 用量</div>
					<div class="item-info"> ${list.FERT_AMOUNT} </div>
				</div>
				<div class="item">
					<div class="item-tag"> 施肥时间</div>
